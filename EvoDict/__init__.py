...
from .exceptionsModule import FusionError, ExportError, ImportationError, ConditionError
...
__all__ = ["Evodict", "Graphe", "FusionError", "ExportError", "ImportationError", "Arbre", "Matrice", "MatriceEchelonneeReduite", "MatriceBinaire", "MatriceTriangulaire", "ArbreBinaire", "GestionRessource", "BellmanFord", "Resolution", "Dijkstra", "GraphePondere", "SystemePermission","ConditionError"]
